...
<%@ page import="soNet.*, controllers.*, controllers.servlets.*, java.util.ArrayList, java.util.List, java.text.DateFormat, java.text.SimpleDateFormat"
 %>
<% 

Authentifikation control = Authentifikation.getInstanz();
Forscher forscher = (Forscher)request.getAttribute("forscherAngemeldet");
...
<body>
		...
		<p class="angemeldetPerson">Angemeldet als: <%=forscher.getVorname() %><button id="abmelden">Abmelden</button></p>
